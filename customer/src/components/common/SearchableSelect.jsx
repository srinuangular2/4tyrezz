  ...
  return (
    <div className="relative" ref={rootRef}>
      <button
        ...
        className={`${inputClass} flex items-center justify-between gap-2 text-left disabled:opacity-60 disabled:cursor-not-allowed ${
          selected ? '' : 'text-slate-400 font-medium'
        }`}
      >
