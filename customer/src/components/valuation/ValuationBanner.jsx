...
const POINTS = [
  { icon: Zap, label: 'Instant estimate', hint: 'See a price range in under a minute' },
  { icon: Lock, label: 'Free & private', hint: 'No payment · your number stays with 4tyrezz' },
  { icon: Gauge, label: 'Based on your car', hint: 'Brand, year, KM, owners & condition' },
];
