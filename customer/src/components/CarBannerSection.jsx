    ...
    <section className="relative my-16 mx-auto overflow-hidden">
      ...
      <div className="relative z-10 p-8 sm:py-12 lg:py-16 max-w-2xl">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4">
          <button className="w-full sm:w-auto px-8 py-4 rounded-2xl bg-[#3083ff] hover:bg-blue-600 text-white font-extrabold text-xs uppercase tracking-wider shadow-lg shadow-[#3083ff]/40 transition-all duration-300 cursor-pointer">
            Claim Offer Now
          </button>
          <button className="w-full sm:w-auto px-8 py-4 rounded-2xl bg-white/10 hover:bg-white/20 text-white border border-white/20 font-extrabold text-xs uppercase tracking-wider backdrop-blur-md transition-all duration-300 cursor-pointer">
