...
//     <Link
//       to={`/cars/${car._id}`}
//       className="group relative flex flex-col h-full bg-white/70 backdrop-blur-md rounded-2xl border border-white/60 shadow-lg hover:shadow-2xl hover:border-red-500/30 transition-all duration-300 overflow-hidden"
//     >
//       {/* Top Ambient Glow Effect on Hover */}
//       <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-transparent via-red-500 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-20" />
...
//             onClick={handleWishlist}
//             aria-label="Add to wishlist"
//             className="pointer-events-auto w-8 h-8 rounded-full bg-white/70 backdrop-blur-md border border-white/60 flex items-center justify-center text-slate-700 hover:bg-white hover:text-red-600 hover:scale-110 active:scale-95 transition-all shadow-md cursor-pointer"
//           >
//             <Heart filled={wishlisted} className={wishlisted ? 'text-red-600 fill-current' : 'text-slate-600'} />
//           </button>
//         </div>
...
//           {/* Title */}
//           <h3 className="text-base font-black text-slate-900 leading-snug line-clamp-1 group-hover:text-red-600 transition-colors duration-200">
//             {car.title}
//           </h3>
...
//             <span className="font-black text-xl text-slate-900 tracking-tight group-hover:text-red-600 transition-colors duration-200">
//               {formatPrice(car.price)}
//             </span>
//           </div>

//           <div className="w-9 h-9 rounded-full bg-slate-900 text-white flex items-center justify-center shadow-md group-hover:bg-red-600 group-hover:shadow-red-500/30 transition-all duration-300">
      ...
      <div className="relative h-52 bg-slate-100 overflow-hidden shrink-0">
        ...
        <div className="absolute top-3.5 left-3.5 right-3.5 flex items-center justify-between z-20 pointer-events-none">
          ...
          <button
            ...
            onClick={handleWishlist}
            aria-label="Add to wishlist"
            className="pointer-events-auto w-9 h-9 rounded-full bg-white/60 backdrop-blur-md border border-white/80 flex items-center justify-center text-slate-700 hover:bg-white hover:text-blue-600 hover:scale-110 active:scale-95 transition-all shadow-lg cursor-pointer"
          >
