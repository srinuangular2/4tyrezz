      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 pb-12 border-b border-slate-800/80">
          ...
          <div>
            ...
            <li><Link to="/contact" className="hover:text-[#3083ff] transition-colors">About Us</Link></li>
            <li><Link to="/contact" className="hover:text-[#3083ff] transition-colors">Contact Us</Link></li>
              ...
              <li><Link to="/refund" className="hover:text-[#3083ff] transition-colors">Refund & Return Policy</Link></li>
              <li><Link to="/faq" className="hover:text-[#3083ff] transition-colors">Help & FAQs</Link></li>
