  ...
  return (
    <section className=" py-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      ...
      <div className="mt-12 flex flex-col sm:flex-row items-center justify-center gap-4">
        <button className="w-full sm:w-auto px-8 py-3.5 rounded-2xl bg-[#3083ff] hover:bg-blue-600 text-white font-black text-xs uppercase tracking-wider shadow-xl shadow-[#3083ff]/35 transition-all duration-300 cursor-pointer">
          Watch How It Works
        </button>
        <button className="w-full sm:w-auto px-8 py-3.5 rounded-2xl bg-[#3083ff]/15 hover:bg-[#3083ff]/25 text-[#3083ff] dark:text-blue-300 border-2 border-[#3083ff]/40 font-black text-xs uppercase tracking-wider backdrop-blur-md transition-all duration-300 cursor-pointer">
          Learn More
        </button>
      </div>
    </section>
