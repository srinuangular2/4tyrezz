      ...
      <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-8 p-8 md:p-12 items-center">
        ...
        <div className="lg:col-span-7 flex flex-col gap-6">
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-black tracking-tight leading-tight">
            Sell Your Car at the <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-100 via-[#3083ff] to-cyan-300">Best Market Price</span> Effortlessly.
          </h2>

          <p className="text-blue-100/80 text-sm md:text-base leading-relaxed max-w-xl">
            Get an instant AI-powered price estimate, free doorstep evaluation, and same-day payment with zero paperwork hassle.
          </p>
        ...
        <div className="lg:col-span-5 grid grid-cols-2 gap-4">
          <div className="p-5 rounded-2xl bg-[#3083ff]/10 backdrop-blur-xl border border-[#3083ff]/30 shadow-lg hover:bg-[#3083ff]/20 hover:border-[#3083ff]/60 transition-all duration-300 flex flex-col justify-between h-36 group">
            ...
            <div>
              <h3 className="text-white font-extrabold text-base">Instant Quote</h3>
              <p className="text-blue-200/60 text-xs mt-0.5">Calculated in under 60s</p>
            </div>
          </div>
          ...
          <div className="p-5 rounded-2xl bg-[#3083ff]/10 backdrop-blur-xl border border-[#3083ff]/30 shadow-lg hover:bg-[#3083ff]/20 hover:border-[#3083ff]/60 transition-all duration-300 flex flex-col justify-between h-36 group">
            ...
            <div>
              <h3 className="text-white font-extrabold text-base">Same Day Payout</h3>
              <p className="text-blue-200/60 text-xs mt-0.5">Direct bank transfer</p>
            </div>
          </div>
          ...
          <div className="p-5 rounded-2xl bg-[#3083ff]/10 backdrop-blur-xl border border-[#3083ff]/30 shadow-lg hover:bg-[#3083ff]/20 hover:border-[#3083ff]/60 transition-all duration-300 flex flex-col justify-between h-36 group">
            ...
            <div>
              <h3 className="text-white font-extrabold text-base">Free Inspection</h3>
              <p className="text-blue-200/60 text-xs mt-0.5">At doorstep location</p>
            </div>
          </div>
          ...
          <div className="p-5 rounded-2xl bg-[#3083ff]/10 backdrop-blur-xl border border-[#3083ff]/30 shadow-lg hover:bg-[#3083ff]/20 hover:border-[#3083ff]/60 transition-all duration-300 flex flex-col justify-between h-36 group">
            ...
            <div>
              <h3 className="text-white font-extrabold text-base">Free RC Transfer</h3>
              <p className="text-blue-200/60 text-xs mt-0.5">100% legal coverage</p>
            </div>
          </div>
        </div>
